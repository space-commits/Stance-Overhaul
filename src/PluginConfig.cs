...
namespace StanceOverhaul
{
    internal static class PluginConfig
    {
        ...
        public static void InitConfigBindings(ConfigFile config)
        {
            ...
            PistolWalkSpeedBonus = config.Bind<float>(pistol, "Pistol Enter Walk Speed Modifier", 1.075f, new ConfigDescription("Multiplier applied to walk speed when in pistol stance.", new AcceptableValueRange<float>(0.1f, 5f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 10, Browsable = true }));

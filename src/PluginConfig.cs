...
namespace StanceOverhaul
{
    internal static class PluginConfig
    {
        ...
        public static void InitConfigBindings(ConfigFile config)
        {
            ...
            string weapAimAndPos = "3. Offsets";
            string movement = "4. Movement";
            string controls = "5. Controls";
            string deviceBonuses = "6. Device Bonuses";
            ...
            BlockFiring = config.Bind<bool>(controls, "Block Shooting While In Stance", false, new ConfigDescription("Blocks Firing While In A Stance, Will Cancel Stance If Attempting To Fire.", null, new ConfigurationManagerAttributes { Order = 250, Browsable = true }));

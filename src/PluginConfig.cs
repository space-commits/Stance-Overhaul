...
namespace StanceOverhaul
{
    internal static class PluginConfig
    {
        ...
        public static void InitConfigBindings(ConfigFile config)
        {
            ...
            RifleOffsetX = config.Bind<float>(weapAimAndPos, "Weapon Position Offset X", -0.04f, new ConfigDescription("Adjusts The Position Of Rifle On Screen.", null, new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 152, Browsable = true }));
            ...
            RifleOffsetZ = config.Bind<float>(weapAimAndPos, "Weapon Position Offset Z", 0f, new ConfigDescription("Adjusts The Position Of Rifle On Screen.", null, new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 152, Browsable = true }));
            PistolOffsetX = config.Bind<float>(weapAimAndPos, "Pistol Position Offset X", -0.095f, new ConfigDescription("Adjusts The Pistol Position Of Pistol On Screen. Changing This Can Lead To ADS Looking Strange, Use With Caution", null, new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 152, Browsable = true }));
            PistolOffsetY = config.Bind<float>(weapAimAndPos, "Pistol Position Offset Y", 0.065f, new ConfigDescription("Adjusts The Pistol Position Of Pistol On Screen. Changing This Can Lead To ADS Looking Strange, Use With Caution", null, new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 152, Browsable = true }));
            PistolOffsetZ = config.Bind<float>(weapAimAndPos, "Pistol Position Offset Z", 0f, new ConfigDescription("Adjusts The Pistol Position Of Pistol On Screen. Changing This Can Lead To ADS Looking Strange, Use With Caution", null, new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 152, Browsable = true }));

...
namespace StanceOverhaul
{
    internal static class PluginConfig
    {
        ...
        public static ConfigEntry<float> GlobalStanceDamping { get; set; }
        public static ConfigEntry<float> GlobalStanceReturnSpeed { get; set; }
        ...
        public static void InitConfigBindings(ConfigFile config)
        {
            ...
            GlobalStanceSpeed = config.Bind<float>(weapAimAndPos, "Global Stance Speed", 2f, new ConfigDescription("Global multiplier for all stance speeds", new AcceptableValueRange<float>(0f, 20f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 150, IsAdvanced = true, Browsable = true }));
            GlobalStanceDamping = config.Bind<float>(weapAimAndPos, "Global Stance Damping", 0.81f, new ConfigDescription("Global multiplier for all stance damping. Defines reactivness to motion, or wiggle.", new AcceptableValueRange<float>(0f, 1f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 150, IsAdvanced = true, Browsable = true }));
            GlobalStanceReturnSpeed = config.Bind<float>(weapAimAndPos, "Global Stance Return Speed", 0.065f, new ConfigDescription("Global multiplier for all stance return speeds. Defines responsivenss and tightness of movement.", new AcceptableValueRange<float>(0f, 10f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 150, IsAdvanced = true, Browsable = true }));
            ...
            HighReadyTransitionFromPatrol = config.Bind<float>(highReady, "High Ready Transition From: Patrol", 1.6f, new ConfigDescription("", new AcceptableValueRange<float>(0f, 50f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 56, IsAdvanced = true, Browsable = true }));
            ...
            HighReadyTransitionToLowReady = config.Bind<float>(highReady, "High Ready Transition To Speed: Low Ready", 0.65f, new ConfigDescription("", new AcceptableValueRange<float>(0f, 50f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 53, IsAdvanced = true, Browsable = true }));
            ...
            HighReadyTransitionToPatrol = config.Bind<float>(highReady, "High Ready Transition To Speed: Patrol", 1.1f, new ConfigDescription("", new AcceptableValueRange<float>(0f, 50f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 51, IsAdvanced = true, Browsable = true }));
            ...
            ShortStockTransitionFromIdle = config.Bind<float>(shortStock, "Short-Stock Transition From: Idle", 2f, new ConfigDescription("Speed of entering Short-Stock from idle (no previous stance).", new AcceptableValueRange<float>(0f, 50f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 6, Browsable = true }));
            ...
            ShortStockTransitionFromHighReady = config.Bind<float>(shortStock, "Short-Stock Transition From: High Ready", 1.75f, new ConfigDescription("", new AcceptableValueRange<float>(0f, 50f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = -4, IsAdvanced = true, Browsable = true }));
            ShortStockTransitionFromLowReady = config.Bind<float>(shortStock, "Short-Stock Transition From: Low Ready", 1.95f, new ConfigDescription("", new AcceptableValueRange<float>(0f, 50f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = -5, IsAdvanced = true, Browsable = true }));
            ...
            PatrolTransitionFromIdle = config.Bind<float>(patrol, "Patrol Transition From: Idle", 2f, new ConfigDescription("Speed of entering Patrol stance from idle (no previous stance).", new AcceptableValueRange<float>(0f, 50f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 51, Browsable = true }));
            ...
            PatrolTransitionFromActiveAim = config.Bind<float>(patrol, "Patrol Transition From: Active Aim", 1.15f, new ConfigDescription("", new AcceptableValueRange<float>(0f, 50f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 40, IsAdvanced = true, Browsable = true }));
            PatrolTransitionFromHighReady = config.Bind<float>(patrol, "Patrol Transition From: High Ready", 1.35f, new ConfigDescription("", new AcceptableValueRange<float>(0f, 50f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 39, IsAdvanced = true, Browsable = true }));
            ...
            PatrolTransitionToActiveAim = config.Bind<float>(patrol, "Patrol Transition To Speed: Active Aim", 1.25f, new ConfigDescription("", new AcceptableValueRange<float>(0f, 50f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 35, IsAdvanced = true, Browsable = true }));
            ...
            LeftShoulderTransitionFromHighReady = config.Bind<float>(leftShoulder, "Left Shoulder Transition From: High Ready", 1.8f, new ConfigDescription("", new AcceptableValueRange<float>(0f, 50f), new ConfigurationManagerAttributes { ShowRangeAsPercent = false, Order = 23, IsAdvanced = true, Browsable = true }));
